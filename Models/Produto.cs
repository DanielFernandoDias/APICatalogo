...
{
    [Table("Produtos")]
    public class Produto : IValidatableObject // Implementando a interface posso criar validações no modelo
    {
        [Key]
        ...
        public int CategoriaId { get; set; }  // Mapera a categoriaID 
        [JsonIgnore]
        public Categoria? Categoria { get; set; } // Produto mapeado a uma categoria
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if(Estoque <= 0)
            {
                yield return new ValidationResult("O estoque deve ser maior que 0", new[]
{
                        nameof(Estoque)
                    });
            }
